...
export default function SpecialtySelection() {
  const specialties = [
    { name: "Cardiología", desc: "Corazón y circulatorio", icon: "cardiology", link: "/dashboard/paciente/agendar/doctor" },
    { name: "Pediatría", desc: "Salud infantil", icon: "child_care", link: "/dashboard/paciente/agendar/doctor" },
    { name: "Dermatología", desc: "Cuidado de la piel", icon: "dermatology", link: "/dashboard/paciente/agendar/doctor" },
    { name: "Ginecología", desc: "Salud reproductiva", icon: "female", link: "/dashboard/paciente/agendar/doctor" },
    { name: "Odontología", desc: "Cuidado dental", icon: "dentistry", link: "/dashboard/paciente/agendar/doctor" },
    { name: "Más", desc: "Ver todas", icon: "grid_view", link: "/dashboard/paciente/agendar/especialidades" },
  ];
    ...
    <main className="relative pt-safe-24 pb-32 px-6 max-w-2xl mx-auto">
      ...
      <section className="mb-10 text-center">
        ...
        <p className="text-[#bcc9ca] text-lg max-w-md mx-auto">
          Selecciona el área médica para encontrar a los mejores profesionales disponibles hoy.
        </p>
      </section>
      ...
      <div className="mt-12 text-center">
        <Link href="/dashboard/paciente/agendar/doctor" className="block w-full py-5 rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-container)] text-white font-headline font-bold text-lg shadow-[0_20px_40px_-10px_rgba(0,105,112,0.4)] hover:scale-[1.02] active:scale-95 transition-all">
          Continuar
        </Link>
        <p className="mt-6 text-sm text-[#bcc9ca] font-medium hover:text-[var(--color-primary-container)] transition-colors">
          ¿No encuentras lo que buscas? Chatea con nosotros
          <Link href="/dashboard/paciente/perfil" className="ml-1 underline underline-offset-4">
            aquí
          </Link>
        </p>
      </div>

      ...
      <div className="space-y-6">
        {filteredDoctors.map((doc, idx) => (
          <div key={idx} className="bg-white/5 backdrop-blur-xl p-6 rounded-[2.5rem] flex flex-col gap-5 relative group overflow-hidden border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.2)]">
            ...
            <Link href="/dashboard/secretaria/agendar/sucursal" className="block text-center w-full bg-[var(--color-primary-container)] text-white font-headline font-bold py-4 rounded-2xl hover:bg-[var(--color-primary-container)]/90 transition-all active:scale-95 shadow-lg shadow-[var(--color-primary-container)]/20">
              Seleccionar
            </Link>
          </div>
        ))}
